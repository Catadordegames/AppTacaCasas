...
export default function AdminLancamentos() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Filtros */}
      <div className="card border border-dark-600 grid grid-cols-2 md:grid-cols-4 gap-3">
        <div>
      ...
      {confirmarReset && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-dark-800 border border-red-700/50 rounded-2xl w-full max-w-sm p-6 space-y-4">
