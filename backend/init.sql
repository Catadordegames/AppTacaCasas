...
CREATE DATABASE IF NOT EXISTS taca_das_casas CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO
    justificativas (nome, pontos)
VALUES ('Participação em aula', 10),
    ...
    ('Projeto especial', 30),
    (
        'Penalidade - mau comportamento',
        -10
    ),
    (
        'Penalidade - falta injustificada',
        -5
    );
